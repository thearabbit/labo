...
class InvoiceBalanceController extends BaseController
{

    public function create()
    {
        $date = date('Y-m-d');
        return \View::make('labo::report.invoice_balance', compact('date'));
    }
    ...
    public function store()
    {
        ...
        // Start PHPExcel
        $rptName = 'Invoice Balance Report';
        $rptExtension = '.xlsx';
